...
from src.model.repositories.interfaces.event_link_repository import EventosLinkRepositoryInterface

class EventLinkCreato:
    ...
    def __check_events_link(self, event_id: int, subscriber_id: int) -> None:
        ...
        if response: raise Exception("Link exists")
